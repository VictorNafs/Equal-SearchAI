...
$reponse = $bdd->prepare("DELETE FROM annonce WHERE id_annonce =:num LIMIT 1");
...
if($executeIsOk)
{
	$message = "Cette annonce à bien été supprimée !";
}
else
{
	$message = "Echec de la suppression de cette annonce";
}
